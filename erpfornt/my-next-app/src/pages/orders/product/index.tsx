...
import {orderListUser, orderModify, orderDelete, orderListProduct} from "@/api/api";
import {modifyOrderData, OrdersDto} from "@/api/datatype";

const OrdersProductPage = () => {
    ...
    const handleSearch = async () => {
        ...
        try {
            const fetchedOrders = await orderListProduct(Number(inputId));
        ...
        <Box sx={{ height: 600, width: '100%' }}>
            ...
            {userOrders.length > 0 ? (
                ...
                <Typography variant="h6" align="center">
                    Enter a Product ID to search for orders.
                </Typography>
            )}
        </Box>
    );
...
export default OrdersProductPage;
